...
public class GunScript : MonoBehaviour {
	...
	*/
	...
	void PositionGun(){
		...
		// 	(toFollow.transform.right * (currentGunPosition.x + currentRecoilXPos)) + 
		// 	(toFollow.transform.up * (currentGunPosition.y+ currentRecoilYPos)) + 
		// 	(toFollow.transform.forward * (currentGunPosition.z + currentRecoilZPos)),ref velV, 0);
